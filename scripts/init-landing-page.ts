// Script to initialize Firebase with current landing page data
// Run this once to populate Firestore with existing content
...
async function initializeLandingPageData() {
  try {
    ...
    console.log("✓ Media coverage created (first 5 items)");
